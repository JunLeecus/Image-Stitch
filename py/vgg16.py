...
class Vgg16:
    ...
    def build(self, rgb):
        ...
        self.gap = self.global_ave_pool(self.conv5_3, "gap")
        ...
        self.prob = tf.nn.softmax(self.gap, name="prob")
    ...
    def global_ave_pool(self, bottom, name):
        return tf.reduce_max(bottom, [1, 2], name=name, keep_dims=True)
